...
func examplePointCloud() *PointCloud {
	...
	return &PointCloud{
		Azimuths: [ColumnsPerPacket]unit.Angle{
			unit.Angle(103.42 * degToRad),
			unit.Angle(103.62 * degToRad),
			unit.Angle(103.82 * degToRad),
			unit.Angle(104.02 * degToRad),
			unit.Angle(104.22 * degToRad),
			unit.Angle(104.42 * degToRad),
			unit.Angle(104.62 * degToRad),
			unit.Angle(104.82 * degToRad),
			unit.Angle(105.02 * degToRad),
			unit.Angle(105.22 * degToRad),
			unit.Angle(105.42 * degToRad),
			unit.Angle(105.62 * degToRad),
			unit.Angle(105.82 * degToRad),
			unit.Angle(106.01 * degToRad),
			unit.Angle(106.21 * degToRad),
			unit.Angle(106.41 * degToRad),
			unit.Angle(106.61 * degToRad),
			unit.Angle(106.8 * degToRad),
			unit.Angle(107 * degToRad),
			unit.Angle(107.2 * degToRad),
			unit.Angle(107.41 * degToRad),
			unit.Angle(107.61 * degToRad),
			unit.Angle(107.81 * degToRad),
			unit.Angle(108.01 * degToRad),
		},
